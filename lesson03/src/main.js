// Array types
var stringArr = ["One", "hey", "Subho"];
var guitars = ["Strats", "Les paul", 5150];
var mixedData = ["EVJ", 1984, true];
...
var greetSinger = function (singer) {
    return "Hello ".concat(singer.name, " !");
};
...
var subho = {
    ...
    giveDiscount: function (value) {
        return "You are given ".concat(value, "% of discount");
    }
};
